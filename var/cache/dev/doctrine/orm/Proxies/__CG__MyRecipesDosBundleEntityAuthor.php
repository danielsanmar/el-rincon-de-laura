...
namespace Proxies\__CG__\MyRecipesDosBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Author extends \MyRecipesDosBundle\Entity\Author implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MyRecipesDosBundle\\Entity\\Author' . "\0" . 'id', 'name', 'surname', 'recipes'];
        }
